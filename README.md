...
# 本アプリケーションはren8(https://github.com/ren8k/aws-bedrock-converse-app-use-tools)のプロジェクトを元に作成されました。
日本語のクエリ指示を受けて、Amazon Bedrock の Converse APIでSQLクエリ文作成してRedshiftからデータを取得し、Streamlitのチャットボットでクエリ結果の表示と対話可能のtool use機能を追加したものです。
> 以下は、ren8/aws-bedrock-converse-app-use-toolsのプロジェクトのREADMEです。
